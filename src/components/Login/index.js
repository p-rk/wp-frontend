        ...
        <div className="column is-4 is-offset-4">
          ...
          {!isLoggedIn && (
            <Fragment>
              ...
              <div className="field">
                <Link to="/otp/login" className="button is-block is-primary is-fullwidth">Login With OTP</Link>
              </div>
              <div className="field">
                {res.error && (
              ...
              <div className="card-content">
                <div className="media">
                  <div className="media-content">
                    <p className="subtitle is-6"><b>Email: </b>{response.user.email}
                      <span className={`icon ${response.user.isEmailVerified ? 'has-text-info' :  'has-text-danger'}`}>
                ...
                <div className="content">
                  <p className="subtitle is-6"><b>Mobile: </b> {response.user.mobile}
                    <span className={`icon ${response.user.isMobileVerified ? 'has-text-info' :  'has-text-danger'}`}>
