...
import { validateMobile, validateOTP } from "../Register/validations";
...
export default class OTPLogin extends Component {
  ...
  handleOtpSubmit = async e => {
    ...
    try {
      ...
      await saveState({ data, isLoggedIn: true });
    } catch (err) {
      const {
        response: { data }
      } = err;
  ...
  componentDidMount() {
    ...
    if (persistedState.isLoggedIn && persistedState.data) {
      this.setState({
        ...
        apiResponse: persistedState.data
      });
    }
  }
  render() {
            ...
            <div className="box">
              {!isLoggedIn && (
                <Fragment>
                  ...
                  <div className="field">
                    {apiResponse && isError && (
                      <p className="control help is-danger">
                        {apiResponse.msg}
                      </p>
                    )}
                  </div>
                ...
                <div className="card">
                  ...
                  <div className="card-content">
                    ...
                    <div className="content">
                      <p className="subtitle is-6">
                        <b>Mobile: </b> {apiResponse.user.mobile}
                        <span
                          className={`icon ${
